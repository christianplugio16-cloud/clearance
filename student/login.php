...
<html>
    <head>
        ...
        <title>CPSU Victorias - Student Clearance System</title>
        <meta content="CPSU Victorias Student Clearance System" name="keywords" />
                ...
                <div class="form-panel">
                    <form role="form" id="login-form" class="index-form">
                        ...
                        <div style="text-align: center; margin-top: 15px;">
                            ...
                            <a href="register.php" style="color: #228B22; font-weight: 500; text-decoration: none; margin-left: 5px;">
